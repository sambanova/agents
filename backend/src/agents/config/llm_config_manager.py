...
class LLMConfigManager:
    ...
    DEFAULT_CONFIG = {
        ...
        "task_models": {
            "main_agent": {"provider": "sambanova", "model": "MiniMax-M2.5", "fallback_model": "gpt-oss-120b"},
            "data_science_agent": {"provider": "sambanova", "model": "MiniMax-M2.5"},
            "data_science_report": {"provider": "sambanova", "model": "MiniMax-M2.5"},
            "data_science_code": {"provider": "sambanova", "model": "MiniMax-M2.5"},
            "data_science_note": {"provider": "sambanova", "model": "Meta-Llama-3.3-70B-Instruct"},
            "data_science_process": {"provider": "sambanova", "model": "MiniMax-M2.5"},
            "data_science_hypothesis": {"provider": "sambanova", "model": "MiniMax-M2.5"},
            ...
            "data_science_visualization": {"provider": "sambanova", "model": "MiniMax-M2.5"},
            "data_science_searcher": {"provider": "sambanova", "model": "MiniMax-M2.5"},
            ...
            "code_execution_agent": {"provider": "sambanova", "model": "MiniMax-M2.5"},
