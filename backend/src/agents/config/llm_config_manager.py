...
class LLMConfigManager:
    ...
    DEFAULT_CONFIG = {
        ...
        "providers": {
            "sambanova": {
                ...
                "models": {
                    ...
                    "MiniMax-M2.7": {"name": "MiniMax M2.7", "context_window": 160000, "max_tokens": 16384},
                    ...
                    "gemma-3-12b-it": {"name": "Gemma 3 12B", "context_window": 16384, "max_tokens": 8192}
                }
            },
            "fireworks": {
        ...
        "task_models": {
            "main_agent": {"provider": "sambanova", "model": "MiniMax-M2.7", "fallback_model": "gpt-oss-120b"},
            "data_science_agent": {"provider": "sambanova", "model": "MiniMax-M2.7"},
            "data_science_report": {"provider": "sambanova", "model": "MiniMax-M2.7"},
            "data_science_code": {"provider": "sambanova", "model": "MiniMax-M2.7"},
            "data_science_note": {"provider": "sambanova", "model": "Meta-Llama-3.3-70B-Instruct"},
            "data_science_process": {"provider": "sambanova", "model": "MiniMax-M2.7"},
            "data_science_hypothesis": {"provider": "sambanova", "model": "MiniMax-M2.7"},
            "data_science_quality_review": {"provider": "sambanova", "model": "gemma-3-12b-it"},
            "data_science_refiner": {"provider": "sambanova", "model": "gpt-oss-120b"},
            "data_science_visualization": {"provider": "sambanova", "model": "MiniMax-M2.7"},
            "data_science_searcher": {"provider": "sambanova", "model": "MiniMax-M2.7"},
            "data_science_human_choice": {"provider": "sambanova", "model": "gpt-oss-120b"},
            "daytona_agent": {"provider": "sambanova", "model": "Meta-Llama-3.3-70B-Instruct"},
            "code_execution_agent": {"provider": "sambanova", "model": "MiniMax-M2.7"},
