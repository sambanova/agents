...
def enhanced_competitor_tool(company_name: str, ticker: str) -> Dict[str, Any]:
    ...
    return {"competitor_tickers": fallback_competitors[:3], "competitor_details": []}
...
def competitor_analysis_tool(tickers: List[str]) -> Dict[str, Any]:
    ...
    return {"competitor_tickers": tickers, "competitor_details": details}
        ...
        details.append(
            {
                ...
                "earnings_growth": "",
                "short_ratio": str(info.get("shortRatio", "")),
                "industry": info.get("data", {})
                .get("company_info", {})
                .get("industry", ""),
                "sector": info.get("data", {})
                .get("company_info", {})
                .get("sector", ""),
            }
        )
