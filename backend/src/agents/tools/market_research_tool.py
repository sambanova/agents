...
from agents.services.market_research_service import MarketResearchService
...
class MarketResearchTool(BaseTool):
    ...
    def _run(
        self, industry: Optional[str] = None, product: Optional[str] = None
    ) -> str:
        """
        ...
        return self.service.generate_market_research(industry=industry, product=product)


if __name__ == "__main__":
    tool = MarketResearchTool(api_key="your_api_key_here")

    test_cases = [{"industry": "hardware", "product": "AI in edge computing"}]
