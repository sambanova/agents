<template>
  ...
  >
    <div class="flex min-h-screen items-center justify-center p-4">
      ...
      <!-- Modal -->
      <div
        class="relative w-full max-w-lg bg-white dark:bg-gray-900 rounded-xl shadow-lg p-6"
      >
        <div class="flex justify-between items-center mb-6">
          <h2
            class="text-2xl font-semibold text-primary-brandTextPrimary dark:text-gray-100"
          >
            API Settings
          </h2>
          <button
            @click="close"
            class="text-primary-brandTextSecondary dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400"
          >
            <svg
              class="w-6 h-6"
              fill="none"
        ...
        <div class="space-y-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              ...
              <a
                ...
                target="_blank"
                class="ml-2 text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 text-sm"
              >
                Get Key →
              </a>
            </label>
            <div class="relative">
              <input
                ...
                class="block w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm p-2 focus:outline-none focus:ring-primary-500 focus:border-primary-500 pr-10 text-gray-900 dark:text-gray-100"
              />
              <button
                @click="toggleSambanovaKeyVisibility"
                class="absolute inset-y-0 right-0 px-3 flex items-center text-primary-brandTextSecondary dark:text-gray-300 hover:text-gray-700 dark:hover:text-gray-400"
              >
                <svg
          ...
          <!-- Serper & Fireworks sections similarly updated... -->
          ...
          <div class="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4">
            ...
            <select
              ...
              class="block w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm p-2 focus:outline-none focus:ring-primary-500 focus:border-primary-500 text-gray-900 dark:text-gray-100"
            >
          ...
          <!-- Provider & FAQ -->
          <div class="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4 flex flex-row justify-between">
            ...
            <div class="flex flex-row items-center">
              <a
                ...
                target="_blank"
                class="text-sm underline text-primary-brandTextSecondary dark:text-gray-300"
              >
                FAQ (SN Community)
              </a>
            </div>
        ...
        >
          <div class="flex min-h-screen items-center justify-center p-4">
            <div class="relative w-full max-w-md bg-white dark:bg-gray-900 rounded-lg shadow-lg p-6">
              <div class="text-center">
                <h3 class="mt-4 text-lg font-medium text-primary-brandTextPrimary dark:text-gray-100">
