  ...
  <div class="vertical-timeline mb-4">
    ...
    <div class="timeline-header flex items-center justify-start">
      ...
      <button
        ...
        class="toggle-btn flex items-center rounded focus:outline-none focus:ring-2 focus:ring-primary-brandColor"
      >
        <svg
          v-if="collapsed"
    ...
    <div
      v-show="!collapsed"
      ref="timelineBodyRef"
      class="timeline-body relative pl-[18px] pt-4 pb-4"
    >
