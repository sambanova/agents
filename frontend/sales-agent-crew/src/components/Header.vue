<template>
  <header class="bg-primary-bodyBg dark:bg-gray-800 sticky top-0 z-50">
    <div class="h-[56px] mx-auto px-6 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4">
        ...
        <h1
          class="text-xl font-bold text-primary-brandTextPrimary dark:text-white tracking-tight text-center"
        >
          Agentic
        </h1>
      </div>
      ...
      <div class="flex items-center space-x-4">
        ...
        <button
          @click="openSettings"
          class="p-2 text-gray-600 dark:text-gray-300 hover:text-primary-brandTextPrimary dark:hover:text-white transition-colors"
        >
          <svg
            width="24"
            height="24"
...
<DarkModeToggle/>
        <SignedIn>
          <UserButton
            ...
            :appearance="{
              elements: {
                avatarBox: 'bg-primary-brandAvatarGray dark:bg-gray-600 h-10 w-10',
              },
            }"
          />
        </SignedIn>
